 ...
 */
function scanClaudeCommands(cwd) {
    const commands = [];
...
function scanCommandDir(dir, prefix, commands, source) {
...
function scanPluginCommands(pluginsDir, commands) {
