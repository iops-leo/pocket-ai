...
import { Copy, User, LogOut, Loader2, Check } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 text-gray-100 min-h-screen bg-gray-950">
            <h1 className="text-3xl font-bold mb-8 text-white">설정</h1>

            <section className="mb-8 p-6 border border-gray-800 rounded-2xl bg-gray-900 shadow-sm">
            ...
            <section className="mb-8 p-6 border border-yellow-500/20 rounded-2xl bg-gradient-to-br from-gray-900 to-yellow-500/5 shadow-sm">
                <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
